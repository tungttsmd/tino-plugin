...
class EnqueueRegister
{
    ...
    public function my_enqueue_scripts()
    {
        ...
        wp_enqueue_script('fetch_control_script', plugins_url('src/public/js/theFetchControl.js', dirname(__FILE__, 3)), array('jquery'), time(), true);
        wp_enqueue_script('binder_control_script', plugins_url('src/public/js/binder.js', dirname(__FILE__, 3)), array('jquery'), time(), true);
        wp_enqueue_script('utilityClass', plugins_url('src/public/js/Utility.js', dirname(__FILE__, 3)), array('jquery'), time(), true);
    ...
    public function my_enqueue_styles()
    {
        ...
        wp_enqueue_style('enqWaitSpinner', plugins_url('src/public/css/WaitSpinner.css', dirname(__FILE__, 3)), array(), '1.0.0');
        wp_enqueue_style('enqPaymentButton', plugins_url('src/public/css/PaymentButton.css', dirname(__FILE__, 3)), array(), '1.0.0');
        wp_enqueue_style('enqInputUiBlock', plugins_url('src/public/css/InputUiBlock.css', dirname(__FILE__, 3)), array(), '1.0.0');
        wp_enqueue_style('enqAlertBox', plugins_url('src/public/css/alertBox.css', dirname(__FILE__, 3)), array(), '1.0.0');
    }
}
