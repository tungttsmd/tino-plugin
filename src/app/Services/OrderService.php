...
class OrderService extends DrawService
{
    ...
    public function orderNew_form()
    {
        ...
        $widget = $this->widget();
        include(betterPath(__FILE__, 3) . 'src/app/Views/widget_orderNew.php');
    }

    public function orderConfirm_form()
    {
        $widget = $this->widget();
        include(betterPath(__FILE__, 3) . 'src/app/Views/widget_orderConfirm.php');
    }

    public function orderPayment_form()
    {
        $widget = $this->widget();
        include(betterPath(__FILE__, 3) . 'src/app/Views/widget_orderPayment.php');
    }
