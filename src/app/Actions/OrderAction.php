...
use App\Services\InvoiceService as ServicesInvoiceService;
use App\Service\InvoiceService as InvoiceService;
...
class OrderAction
{
    ...
    public function orderPayment($domainNanme, $nameservers, $auth, $widget_data)
    {
        ...
        # Vẽ hoá đơn
        $invoice_html = ServicesInvoiceService::make()
            ->data($widget_data)
    ...
    public function orderInvoiceDraw($invoice_id, $auth, $widget_data)
    {
        ...
        # Vẽ hoá đơn
        ob_start();
        InvoiceService::make()->invoiceQrDraw($invoice_id);
        return ob_get_clean();
